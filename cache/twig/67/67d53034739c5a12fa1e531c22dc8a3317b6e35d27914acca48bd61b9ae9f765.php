...
class __TwigTemplate_1e52fa1196af612cdcfb377d910108ab4e187ab22653a4a2888efced780a7101 extends \Twig\Template
{
...
($context["image"] ?? null)) {
    ...
    {
        return array (  106 => 21,  100 => 19,  92 => 17,  90 => 16,  85 => 15,  82 => 14,  77 => 13,  68 => 11,  61 => 10,  59 => 9,  56 => 8,  53 => 7,  50 => 6,  45 => 5,  42 => 4,  39 => 3,  29 => 1,);
    }
...
{% block particle %}
    ...
    {% if particle.link == true %}
        <a href=\"{{ url }}\" target=\"{{ particle.target|default('_self') }}\" 
                title=\"{{ particle.text }}\" {{ rel|default('')|raw }} {{ class|default('')|raw }}>
    {% else %}
        <div {{ class|default('')|raw }}>{% endif %}
...
{% endblock %}
", "@particles/logo.html.twig", "/Users/sotiris/Downloads/default_site_backup--20250926220607/user/themes/g5_zeus/particles/logo.html.twig");
    }
}
