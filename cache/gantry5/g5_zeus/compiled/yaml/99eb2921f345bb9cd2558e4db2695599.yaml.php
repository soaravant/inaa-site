...
return [
    ...
    'filename' => '/Users/sotiris/Downloads/default_site_backup--20250926220607/user/themes/g5_zeus/particles/topheadlinesSZ.yaml',
    'modified' => 1544979752,
    'data' => [
        'name' => 'Top Headlines',
        'description' => 'Display only headlines from Joomla Articles - BETA MODE.',
        'type' => 'particle',
        'icon' => 'fa-joomla',
        'form' => [
            'fields' => [
