...
return [
    ...
    'filename' => '/Users/sotiris/Downloads/default_site_backup--20250926220607/user/themes/g5_zeus/blueprints/styles/zenith.yaml',
    'modified' => 1764939253,
    'data' => [
        'name' => 'Zenith Styles',
        'description' => 'Zenith section styles for the Zeus theme',
        'type' => 'section',
        'form' => [
            'fields' => [
                'section-preset' => [
