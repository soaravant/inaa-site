...
return [
    ...
    'filename' => '/Users/sotiris/Downloads/default_site_backup--20250926220607/user/themes/g5_zeus/blueprints/styles/above.yaml',
    'modified' => 1764939829,
    'data' => [
        'name' => 'Above Styles',
        'description' => 'Above section styles for the Zeus theme',
        'type' => 'section',
        'form' => [
            'fields' => [
                'section-preset' => [
