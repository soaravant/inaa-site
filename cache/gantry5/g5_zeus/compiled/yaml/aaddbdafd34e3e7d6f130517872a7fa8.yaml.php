...
return [
    ...
    'filename' => '/Users/sotiris/Downloads/default_site_backup--20250926220607/user/themes/g5_zeus/particles/featuredarticlesSZ.yaml',
    'modified' => 1544979752,
    'data' => [
        'name' => 'Top Articles',
        'description' => 'Display up to five selected articles in various layouts.',
        'type' => 'particle',
        'icon' => 'fa-newspaper-o',
        'form' => [
            'fields' => [
