...
return [
    ...
    'filename' => '/Users/sotiris/Downloads/default_site_backup--20250926220607/user/themes/g5_zeus/blueprints/styles/header.yaml',
    'modified' => 1538656288,
    'data' => [
        'name' => 'Header Styles',
        'description' => 'Header section styles for the Zeus theme',
        'type' => 'section',
        'form' => [
            'fields' => [
                'section-preset' => [
