...
return [
    ...
    'timestamp' => 1762202605,
    'checksum' => '97c78f7450a40503e16320c48c2fe3dc',
    'files' => [
        ...
        'user/themes' => [
            ...
            'themes/g5_zeus' => [
                'file' => 'user/themes/g5_zeus/blueprints.yaml',
                'modified' => 1546554770
            ]
        ]
    ],
    'data' => [
        'items' => [
            ...
            'plugins.quick-tray-links.links.*.external' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.quick-tray-links.links.*.external',
                'validation' => 'strict'
            ],
            'plugins.quick-tray-links.links.*.authorize' => [
                'ignore_empty' => true,
                'validate' => [
                    'type' => 'array',
                    'value_type' => 'bool'
                ...
                'data_type' => 'access',
                'name' => 'plugins.quick-tray-links.links.*.authorize',
                'validation' => 'strict'
            ],
            'plugins.error' => [
                'type' => '_root',
                ...
                'quick-tray-links' => [
                    ...
                    'links' => [
                        '*' => [
                            ...
                            'external' => 'plugins.quick-tray-links.links.*.external',
                            'authorize' => 'plugins.quick-tray-links.links.*.authorize'
                        ]
                    ]
                ],
                'error' => [
